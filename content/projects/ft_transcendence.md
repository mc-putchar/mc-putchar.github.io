...
date: 2024-10-01
description: Free open-source web platform, mainly for playing Pong games and tournaments.
tags: [Django, JavaScript, Docker, PostgreSQL, Redis, Caddy, Cloudflare, Ethereum]
draft: false
---
...
![IMAGE_PLACEHOLDER](/img/ft_transcendence/jinja-dashboard.png)
...
![Architecture](/img/ft_transcendence/napkin-design.png)
...
![Pong3D](/img/ft_transcendence/pong3d.gif)
