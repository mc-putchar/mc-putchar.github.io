---
title: Drone Dance Dialog
date: 2024-06-01
description: An open source application designed for motion capture, choreographing and visualizing drones accurately in space using the OptiTrack system.
tags: [C++, React, ESP32, OptiTrack, Docker]
draft: false
---

# Drone Dance Dialog

![Project Preview](https://github.com/mc-putchar/ddd-opti/blob/main/extras/Control.png)
...
![3D Data Tuning Tool](https://github.com/mc-putchar/ddd-opti/blob/main/extras/PID.png)  
...
![System Architecture Diagram](https://github.com/mc-putchar/ddd-opti/blob/main/extras/Data.png)  
...
![Drone Left-Right Movement](https://github.com/mc-putchar/ddd-opti/blob/main/extras/demo.gif)  
